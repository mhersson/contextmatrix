...
import { filterCardCosts, paginateItems } from '../../utils/costTableUtils';
  ...
  if (sortedAgents.length === 0 && sortedCards.length === 0) {
    return (
      <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--bg1)' }}>
        <h3 className="section-eyebrow mb-3">Cost Breakdown</h3>
  ...
  return (
    <div className="space-y-4">
      {sortedAgents.length > 0 && (
        <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--bg1)' }}>
          <h3 className="section-eyebrow mb-3">Cost by Agent</h3>
      ...
      {sortedCards.length > 0 && (
        <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--bg1)' }}>
          <h3 className="section-eyebrow mb-3">Cost by Card</h3>
                ...
                <tbody>
                  {visibleCards.map((card) => (
                    <tr key={card.card_id} className="border-t" style={{ borderColor: 'var(--bg3)' }}>
                      <td className="py-1.5" style={{ color: 'var(--grey1)', fontFamily: 'var(--font-mono)' }}>
                        {card.card_id}
                      </td>
